...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	/////////////////////////////////////////
	m_button_reset = new wxButton(this, wxID_ANY, _("Reset"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer2->Add(m_button_reset, 0, wxALIGN_CENTER, 5);
	/////////////////////////////////////////
	...
	m_button_reset->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_button_reset_click), NULL, this);
}
...
MyFrame1::~MyFrame1()
{
	...
	m_button_reset->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_button_reset_click), NULL, this);
}
